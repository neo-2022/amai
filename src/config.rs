...
pub struct AppConfig {
    ...
    pub benchmark_qdrant_http_url: Option<String>,
    pub benchmark_qdrant_collection_code: Option<String>,
...
impl AppConfig {
    pub fn from_env() -> Result<Self> {
        Ok(Self {
            ...
            benchmark_qdrant_http_url: env::var("AMI_BENCHMARK_QDRANT_HTTP_URL").ok(),
            benchmark_qdrant_collection_code: env::var("AMI_BENCHMARK_QDRANT_COLLECTION_CODE").ok(),
