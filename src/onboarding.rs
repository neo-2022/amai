...
"#,
    ...
    fn renders_vscode_startup_instructions_with_repo_root() {
        ...
        assert!(text.contains("реальная экономия на полной шкале клиента помечена как `не доказано`"));
