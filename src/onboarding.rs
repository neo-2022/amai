...
"#,
    ...
    fn renders_machine_readable_startup_contract_artifact() {
        ...
        assert_eq!(
            ...
            json!("continuity-startup-contract-v10")
        );
        assert_eq!(
