...
"#,
    ...
    fn renders_machine_readable_startup_contract_artifact() {
        ...
        assert_eq!(
            ...
            json!("continuity-startup-contract-v12")
        );
        assert_eq!(
