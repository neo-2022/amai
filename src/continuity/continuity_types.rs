...
pub(crate) struct StartupRuntimeStateAudit {
    ...
    pub agent_workflow_guard_present: Option<bool>,
    ...
    pub required_task_set_field_present: Option<bool>,
    pub required_task_set_summary_field_present: Option<bool>,
    pub execctl_active_lease_field_present: Option<bool>,
    pub execctl_active_lease_source_event_id_present: Option<bool>,
    pub working_state_restore_lineage_event_present: Option<bool>,
    ...
    pub required_task_set_count_consistent: Option<bool>,
    pub required_task_set_presence_consistent: Option<bool>,
    pub must_preserve_required_task_set_consistent: Option<bool>,
