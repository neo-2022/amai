...
chmod +x \
  "${sandbox_repo}/scripts/bootstrap_stack.sh" \
  "${sandbox_repo}/scripts/prepare_stack_runtime.sh" \
  "${sandbox_repo}/scripts/load_env.sh" \
  "${sandbox_repo}/scripts/resolve_cargo.sh" \
  "${sandbox_repo}/scripts/resolve_rustc.sh" \
  "${sandbox_repo}/scripts/render_postgres_config.sh" \
  "${sandbox_repo}/scripts/render_nats_config.sh"
