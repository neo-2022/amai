...
grep -q '"required_action_kind_field": "required_action_kind_when_resume_required"' .amai/onboarding/project-chat-startup-contract.json
grep -q '"no_silent_drop_field": "no_silent_drop"' .amai/onboarding/project-chat-startup-contract.json
