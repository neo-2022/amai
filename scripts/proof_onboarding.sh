...
grep -q 'KPI/reply prefix сейчас отключён как обязательный startup-law' "${startup_output}"
grep -q 'required_reply_prefix_source = disabled_by_project_policy' "${startup_output}"
